      ...
      <div className="relative z-10 flex flex-col h-full justify-between gap-12">
        ...
        <div className="flex justify-between items-start w-full">
          ...
          <div className="text-right hidden sm:block">
            ...
            <p className="text-sm font-semibold text-slate-500">Buenos Aires, ARG</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          >
            Design Engineer crafting digital perfection. Bridging the gap between <span className="text-indigo-600 font-black relative inline-block">AESTHETICS</span> and <span className="text-slate-900 font-black">ENGINEERING</span>.
          </motion.p>
        </div>
