...
export const ContactCard: React.FC = () => {
  return (
    <div className="h-full bg-white rounded-[2rem] p-8 flex flex-col justify-center relative overflow-hidden group cursor-pointer border border-slate-100 shadow-sm hover:border-indigo-100 hover:shadow-lg transition-all duration-500">
